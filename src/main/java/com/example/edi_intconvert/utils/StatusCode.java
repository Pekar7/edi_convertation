...
public enum StatusCode {
    ...
    MON_OK(70, "Сообщение успешно обработано модулем мониторинга"),
    MON_ERROR(71, "Ошибка в модуле мониторинга"),

    INT_OUT_OK(80, "Сообщение успешно обработано модулем интеграции передачи"),
    INT_OUT_ERROR(81, "Ошибка в модуле интеграции передачи");
